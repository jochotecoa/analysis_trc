...
datafile.name = paste0(comp, 'UNTR_correlation_results_TRC_protein_1onseveral_until072_minimumexpressedsamples-12_shift-TRUE_timeps-shifted-002.tsv')
...
for (s in shifts) {
  ...
  mart.human = useMart(biomart = 'ENSEMBL_MART_ENSEMBL', dataset = 'hsapiens_gene_ensembl') 
